...
package.name = buildozer_template
...
## NOTE: QtActivity is only available when using the Qt bootstrap (p4a.bootstrap = qt)
## from the custom p4a fork. With the standard SDL2 bootstrap, this class does not exist
## and causes ClassNotFoundException at runtime.
android.entrypoint = org.kivy.android.PythonActivity
...
# OUYA-ODK/libs/*.jar
## NOTE: Qt6AndroidBindings.jar provides org.qtproject.qt.android.bindings.QtActivity
## which PythonActivity.java extends. Without it, Java compilation fails.
...
## NOTE: For PySide6, pre-built wheels are only available for aarch64 (arm64-v8a) and x86_64.
## armeabi-v7a and x86 require manual cross-compilation of Qt for Python wheels.
...
## with __init__.py files that unzip the Android wheels into site-packages.
...
## The qt bootstrap provides org.qtproject.qt.android.bindings.QtActivity.
p4a.bootstrap = qt
...
## NOTE: The Qt bootstrap requires --qt-libs and --load-local-libs.
